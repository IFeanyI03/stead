import { EcosystemCard } from "./commons/EcosystemCard";
...
export const Ecosystem = () => (
    ...
    <div className="w-[92.1875%] h-fit flex items-center gap-12 flex-col">
        <p className="font-bold w-fit text-[40px]">Our Ecosystem</p>
        <div className="flex flex-col gap-12">
            {EcosystemData.map((data) => <EcosystemCard data={data} />)}
        </div>
    </div>
)